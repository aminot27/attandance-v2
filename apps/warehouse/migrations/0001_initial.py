# Generated by Django 4.0 on 2024-01-27 06:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('early_tolerance_until', models.TimeField(blank=True, null=True, verbose_name='Tolerancia Temprano Hasta')),
                ('late_tolerance_until', models.TimeField(blank=True, null=True, verbose_name='Tolerancia Tarde Hasta')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('CREATED', 'CREATED'), ('UPDATED', 'UPDATED'), ('DELETED', 'DELETED'), ('ACTIVE', 'ACTIVE'), ('INACTIVE', 'INACTIVE')], default='Present', max_length=10, verbose_name='Attendance Status')),
                ('shift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='warehouse.shift', verbose_name='Shift')),
                ('student', models.ForeignKey(db_column='student_id', on_delete=django.db.models.deletion.DO_NOTHING, to='warehouse.student', verbose_name='Student')),
            ],
            options={
